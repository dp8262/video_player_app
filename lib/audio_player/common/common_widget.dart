        ...
        children: [
          ...
          Expanded(
            child: Stack(children: [
              ...
              SliderTheme(
                data: _sliderThemeData.copyWith(
                    inactiveTrackColor: Colors.transparent, activeTrackColor: AllColors.blackColor, thumbColor: AllColors.blackColor),
                child: Slider(
                  min: 0.0,
                  max: widget.duration.inMilliseconds.toDouble(),
          ...
          Text(RegExp(r'((^0*[1-9]\d*:)?\d{2}:\d{2})\.\d+$').firstMatch("${widget.duration}")?.group(1) ?? "${widget.duration}",
              style: Theme.of(context).textTheme.caption),
        ],
      ),
    );
